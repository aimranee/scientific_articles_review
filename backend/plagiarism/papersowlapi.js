...
//s    PHPSESSID: "qjc72e3vvacbtn4jd1af1k5qn1",
  ...
  const burp0_data = {
    ...
    title: '',
    text: "Le dragon est une créature légendaire représentée comme une sorte de gigantesque reptile, ailes déployées et pattes armées de griffes.",  // Use the text from the request body
  };
